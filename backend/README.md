...
## Project Structure
    ...
    ├── dispatch_locate_42213  # Django project configurations
...
1. Clone this repo and `cd dispatch_locate_42213`
...
2. Clone this repo and `cd dispatch_locate_42213`
