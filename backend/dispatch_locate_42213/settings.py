"""
Django settings for dispatch_locate_42213 project.
...
ROOT_URLCONF = 'dispatch_locate_42213.urls'
...
WSGI_APPLICATION = 'dispatch_locate_42213.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dispatch_locate_42213 API",
    "DESCRIPTION": "API documentation for dispatch_locate_42213 App",
    "VERSION": "v1",
}
